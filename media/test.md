...
<script type="text/javascript">
    (function (window) {
        function setup(TSC) {
             TSC.playerConfiguration.addMediaSrc("https://dynatrace-my.sharepoint.com/personal/daniel_braaf_dynatrace_com/Documents/CIDEMO/videos/ci_sandbox_install.mp4");
             TSC.playerConfiguration.setXMPSrc("cddemosetup_config.xml");
             ...
             TSC.playerConfiguration.setPosterImageSrc("cddemosetup_First_Frame.png");
